...
describe "test_specifications/new.html.erb" do
  before(:each) do
    assign(:test_specification, stub_model(TestSpecification,
      :product_id => 1,
      :user_id => 1,
      :name => "MyString",
  ...
  it "renders new test_specification form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => test_specifications_path, :method => "post" do
